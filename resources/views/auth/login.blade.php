                ...
                <div class="login-form">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="input-boxes">
                            ...
                            <div class="text sign-up-text">Belum punya akun? <label for="flip">Daftar sekarang</label>
                            </div>
                        </div>
                    </form>
                        ...
                        <div class="input-boxes">
                            ...
                            <div class="input-box">
                                ...
                                <input id="kelas" type="text" placeholder="Enter your class" required
                                    ...
                                    value="{{ old('kelas') }}" autocomplete="kelas" autofocus>
                                @error('kelas')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="input-box">
                                ...
                                <input id="jk" type="text" placeholder="Enter your gender" required
                                    ...
                                    value="{{ old('jk') }}" autocomplete="jk" autofocus>
                                @error('jk')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="input-box">
                                ...
                                <input id="email" type="text" placeholder="Enter your email" required
                                    class="form-control @error('email') is-invalid @enderror" name="email"
                                    value="{{ old('email') }}" autocomplete="email" pattern="[^@\s]+@[^@\s]+\.[^@\s]+"
                            ...
                            <div class="input-box">
                                ...
                                <input id="password" type="password"
                                    ...
                                    autocomplete="new-password" pattern=".{8,}"
                            ...
                            <div class="input-box">
                                ...
                                <span id="password-match" class="invalid-feedback" role="alert"
                                    style="display: none;">
                            ...
                            <div class="button input-box"
                                ...
                                <button type="submit" style="padding: 10px 50%;">
                                    {{ __('Login') }}
                                </button>
                            </div>
